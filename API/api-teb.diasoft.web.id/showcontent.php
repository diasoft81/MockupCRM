...
$target_file = $base_dir . DIRECTORY_SEPARATOR . $email_path . DIRECTORY_SEPARATOR . $guid . DIRECTORY_SEPARATOR . $json_file;

// Log untuk debugging
error_log("Requested Email: " . $email);
error_log("Requested GUID: " . $guid);
